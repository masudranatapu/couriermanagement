            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('rider.dashboard')}}">Home</a></li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile_update">
                                <form class="form-horizontal" action="{{route('rider.profile.update', Auth::user()->id)}}" enctype="multipart/form-data" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane" id="password_update">
                                <form class="form-horizontal" action="{{ route('rider.password.update', Auth::user()->id) }}" method="post">
                                    @csrf
                                    <div class="form-group row">
