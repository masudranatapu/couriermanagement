                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <p class="text-muted text-center">Account Manager</p>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="profile_update">
                                <form class="form-horizontal" action="{{route('account.profile.update', Auth::user()->id)}}" enctype="multipart/form-data" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane" id="password_update">
                                <form class="form-horizontal" action="{{ route('account.password.update', Auth::user()->id) }}" method="post">
                                    @csrf
                                    <div class="form-group row">
